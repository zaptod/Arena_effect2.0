...
def show_selection_carousel(screen):
	...
	while running:
		...
		armas_info = font_small.render('(1 arma por personagem)', True, (200,200,200))
		screen.blit(armas_info, (280, 50))
		y_armas = 90
		...
		info_text = f"Personagens: {len(selected_personagens)} | Armas: {len(selected_armas)}"
		info_surface = font_small.render(info_text, True, (255,255,200))
		screen.blit(info_surface, (250, 370))
