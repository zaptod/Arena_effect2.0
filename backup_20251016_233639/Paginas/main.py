...
def main():
    ...
    # Botões principais
    buttons = {
        'personagens': pygame.Rect(WIDTH//2 - 150, 150, 300, 60),
        'armas': pygame.Rect(WIDTH//2 - 150, 230, 300, 60),
        'mapas': pygame.Rect(WIDTH//2 - 150, 310, 300, 60),
        'simulation': pygame.Rect(WIDTH//2 - 150, 410, 300, 60)
    }
    ...
    while running:
        ...
        info_lines = [
            ...
            "Simulação: Combate em tempo real"
        ]
